  ...
  <article class="hoc container clear"> 
    ...
    <figure>
      <ul class="nospace group logos">
        <li class="one_quarter first"><a href="#"><img src="../img/images/demo/222x100.png" alt=""></a></li>
        <li class="one_quarter"><a href="#"><img src="../img/images/demo/222x100.png" alt=""></a></li>
        <li class="one_quarter"><a href="#"><img src="../img/images/demo/222x100.png" alt=""></a></li>
        <li class="one_quarter"><a href="#"><img src="../img/images/demo/222x100.png" alt=""></a></li>
      </ul>
    </figure>
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <ul class="nospace group">
      <li class="one_third first">
        <article class="excerpt"><a href="#"><img class="inspace-10 borderedbox" src="../img/images/demo/320x220.png" alt=""></a>
...
<script src="../js/layout/scripts/jquery.backtotop.js"></script>
<script src="../js/layout/scripts/jquery.mobilemenu.js"></script>
<script src="../js/layout/scripts/jquery.flexslider-min.js"></script>
</body>
</html>